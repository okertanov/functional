/*
    @file win32-scratch-program.cpp
    @brief The Old New Thing: The new scratch program.
           I think it's time to update the scratch program we've been using for the past year.
           I hear there's this new language called C++ that's going to become really popular any day now,
           so let's hop on the bandwagon!
    @see http://blogs.msdn.com/b/oldnewthing/archive/2005/04/22/410773.aspx
*/
